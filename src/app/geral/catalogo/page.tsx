...
import { enumGenero, enumPorte, tbPet, statusArray } from "@/types";
            ...
            >
              <CardMedia
                ...
                image={
                  ...
                  fotoMap[String(animal.id_pet ?? "")].length > 0
                    ? fotoMap[String(animal.id_pet ?? "")]
                    : "/images/patas.png"
                }
              ...
              <CardContent>
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  ...
                  <Chip
                    label={
                      animal.tb_pet_genero === enumGenero.MASCULINO
                        ? "Macho"
                        : "Fêmea"
                    }
                    color={
                  ...
                  />
                  <Chip
                    label={enumPorte[animal.tb_pet_porte]}
                    variant="outlined"
                  />
                  <Chip
                    label={`${calcularIdade(
                      animal.tb_pet_data_nascimento
                    )} anos(s)`}
                    color="primary"
                    variant="outlined"
                  />
